...
//The code was modified after generation
// Class SignedSignaturePropertiesType's prop SigningTime has got a helper twin SigningTimeAsString to make ToString() coorect wuile serialization
namespace IPS.Signature.Xades
{
    ...
    public partial class SignedSignaturePropertiesType
    {
        ...
        [System.Xml.Serialization.XmlElement("SigningTime")]
        public System.String SigningTimeAsString
        {
            get { return SigningTime.ToString("yyyy-MM-ddTHH:mm:sszzz"); }
            set { SigningTime = System.DateTime.Parse(value); }
        }
